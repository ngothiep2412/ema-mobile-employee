...
import 'package:hrea_mobile_employee/app/modules/timeline_reassign/views/timeline_title_ui.dart';
    ...
    return TimeLineTileUI(
      ...
      eventChild: Column(
        ...
        children: [
          ...
          Text(DateFormat('EEEE, dd MMM yy, HH:mm', 'vi_VN').format(assignTask.createdAt!.toLocal()),
